...
struct FileHelperImpl: FileHelper {
    ...
    func copy(from: String, to: String) {
        ui.debug(
            prefix + Colors.cyan + " copy " + Colors.reset + from + Colors.cyan + " to "
                + Colors.reset + to)
    ...
    func exist(_ file: String) -> Bool {
        ui.debug(prefix + Colors.cyan + " check if file exists " + Colors.reset + file)

        return fileManager.fileExists(atPath: file)
    }

    func list(_ path: String) -> [String]? {
        ui.debug(prefix + Colors.cyan + " list " + Colors.reset + path)
    ...
    func createDir(_ file: String, withIntermediateDirectories: Bool = false) -> Bool {
        ui.debug(prefix + Colors.cyan + " create " + Colors.reset + file)
    ...
    func readFile(_ path: String) -> String? {
        ui.debug(prefix + Colors.cyan + " read " + Colors.reset + path)
    ...
    func isDir(_ path: String) -> Bool {
        ui.debug(prefix + Colors.cyan + " check if is dir " + Colors.reset + path)
    ...
    func move(from: String, to: String) {
        ui.debug(
            prefix + Colors.cyan + " move file " + Colors.reset + from + Colors.cyan + " to "
                + Colors.reset + to)
    ...
    func write(content: String, path: String) {
        ui.debug(prefix + Colors.cyan + " write to " + Colors.reset + path)
